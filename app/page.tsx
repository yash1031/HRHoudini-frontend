...
export default function HomePage() {
  ...
  //     case "active":
  //       return scenarios.filter((scenario) => scenario.is_active)
  //     case "inactive":
  //       return scenarios.filter((scenario) => !scenario.is_active)
  //     case "all":
  //     default:
  ...
  //           <Link href={isUserLoggedIn? `/onboarding-upload-only`: "/login"}>
  ...
  //                       ? "No Active Scenarios"
  //                       : scenarioFilter === "inactive"
  //                         ? "No Inactive Scenarios"
  //                         : "No Demo Scenarios"}
  //                   </h3>
  //                   <p className="text-gray-600 mb-4">
  //                     {scenarioFilter === "active"
  //                       ? "All scenarios are currently inactive."
  //                       : scenarioFilter === "inactive"
  //                         ? "All scenarios are currently active."
  ...
  //                   isFirstTile={index === 0} // Pass isFirstTile prop to expand first scenario by default
  //                 />
  //               ))
  //             )}
  //           </div>
